    ...
    useEffect(() => {
        async function getPostById(postId) {
            const { data, error } = await supabase
              .from('Posts')        // Name of the table
              .select('*')          // Select all columns, or you can specify specific columns
              .eq('post_id', postId) // Fetch row where post_id matches the input postId
              .single()             // Since we expect a single post
        ...
        <section className='post'>
            ...
            <div className='post__socialDateContainer'>
                ...
                <div className='socialDateContainer__socialMediaContainer'>
                    <a 
                        href={`https://api.whatsapp.com/send?url=${postURL}`} 
                        target="_blank" 
